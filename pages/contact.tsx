...
export default function Contact() {
  return (
    <>
      ...
      <main className="mx-auto flex max-w-4xl pt-8">
        <ul className="columns-3 gap-8 space-y-2 text-sm">
          <li className="flex items-center">
            ...
            <span className="ml-2">lukasnehrke.dev</span>
          </li>
          <li className="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ml-2">lukasnehrke@protonmail.com</span>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="ml-2">@lukasnehrke</span>
            </a>
          </li>
          <li className="flex items-center">
            <svg
            ...
            <span className="ml-2">~ritsyx-nosfus</span>
          </li>
          <li>
            <a className="flex items-center" href="#">
              ...
              <span className="ml-2">View GPG Key</span>
            </a>
          </li>
        </ul>
      </main>
