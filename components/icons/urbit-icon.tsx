...
// prettier-ignore
export default function UrbitIcon(props: { className?: string }) {
  return (
    <svg className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
      <circle cx="16" cy="16" r="13" fill="transparent" stroke="currentColor" strokeWidth="2" />
