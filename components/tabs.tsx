  ...
  return (
    <nav className="flex items-center justify-center space-x-2" role="tablist">
      {tabs.map((tab, index) => {
        ...
        const cn = clsx(
          "text-sm font-medium text-gray-900 py-2 px-3 rounded-md transition-colors select-none hover:bg-slate-100 hover:bg-opacity-80 hover:dark:bg-gray-700 dark:text-white",
